...
public class ToastUtil {
	...
	public static void toast(Context ctx, String message) {
		...
		LayoutInflater inf = (LayoutInflater) ctx
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		RelativeLayout main = (RelativeLayout) inf.inflate(R.layout.toast, null);
	...
	public static void errorToast(Context ctx, String message) {
		...
		LayoutInflater inf = (LayoutInflater) ctx
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		LinearLayout main = (LinearLayout) inf.inflate(R.layout.toast_error,
				null);
	...
	public static void serverUnavailable(Context ctx) {
		...
		ToastUtil
				.errorToast(
						ctx,
						"Server is not available or reachable at "
